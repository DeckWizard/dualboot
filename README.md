...
- Boot into Windows, create a folder in the C:/ Drive called ```boot```, download the following file - [Download](shorturl.at/pxBIJ)```bootsequence-rEFInd-first.ps1``` & place it in the ```boot``` folder.
